/**
 * Initialize the select fields by creating custom dropdown elements
 * @param {string} className - The class name of the select field container
 */
function initializeSelectFields(className) {
   ...
   * @param {HTMLElement} elmnt - The current select box element
   */
